...
| [animation.md](animation.md) | The frozen-frame model, the four patterns, declaring what you apply, the fifteen library recipes, the entrances a user can pick, per-animation fields |
